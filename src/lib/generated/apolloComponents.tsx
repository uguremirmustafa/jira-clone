...
export type CreateIssueWithTitleMutation = { insert_issues_one?: Maybe<Pick<Issues, 'id'>> };
...
export type UpdateIssuesOrderMutation = { insert_issues?: Maybe<Pick<Issues_Mutation_Response, 'affected_rows'>> };
...
export type GetProjectByIdQuery = { projects_by_pk?: Maybe<(
    ...
    & { project_members: Array<(
      ...
      & { issues: Array<Pick<Issues, 'id' | 'index' | 'title' | 'description' | 'type' | 'project_id' | 'priority' | 'column_id'>> }
    )>, columns_aggregate: { aggregate?: Maybe<Pick<Columns_Aggregate_Fields, 'count'>> } }
  )> };
